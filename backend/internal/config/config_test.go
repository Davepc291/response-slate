...
func clearRecordingEnv(t *testing.T) {
	...
	for _, name := range []string{"GFR_AUTH_ENABLED", "GFR_AUTH_SESSION_IDLE_TIMEOUT", "GFR_AUTH_SESSION_MAX_LIFETIME",
		"GFR_AUTH_PASSWORD_RESET_TTL", "GFR_AUTH_INVITATION_TTL", "GFR_AUTH_SESSION_SECRET", "GFR_AUTH_ALLOWED_ORIGINS", "GFR_AUTH_TRUSTED_PROXIES",
		...
		"GFR_AUTH_MFA_RP_ID", "GFR_AUTH_MFA_RP_DISPLAY_NAME"} {
		t.Setenv(name, "")
	}
}
